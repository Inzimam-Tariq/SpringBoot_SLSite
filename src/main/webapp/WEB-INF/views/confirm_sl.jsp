        ...
        <body style="padding-bottom: 70px;" onload="startCountdown()">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!--/actual content body -->
                    <div class="col-sm-6" >
                        <h1 class="display-4 d-md-display-4"><b>Confirm Shortlink</b></h1>
                        <div class="container-fluid"><br>
                            ...
                            <form class="d-flex flex-column justify-content-center align-items-center" action="confirm_sl" method="Post">
                                <h2><label id="countdownLbl"/></h2>
